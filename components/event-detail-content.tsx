        ...
        <div className='flex flex-col gap-6'>
            ...
            <Card>
                ...
                <CardContent className='space-y-3'>
                    <p className='text-sm text-muted-foreground'>Share this link this link with guests</p>
                    {
                        inviteUrl ? (
                        ...
                        ) : <p className='text-sm text-muted-foreground'>No url link generated yet</p>
                    }
